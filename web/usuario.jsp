                    ...
                    <tbody>
                        ...
                        %>
                            <div class="alert alert-success content2" role="alert">
                                ...
                                <%out.println("<strong>¡Bien hecho!</strong> El Usuario ha sido creado con éxito."); %> 
                            </div> 
                        <%
                        ...
                        %>
                            <div class="alert alert-success content2" role="alert">
                                ...
                                <%out.println("<strong>¡Bien hecho!</strong> El Usuario se elimino satisfactoriamente."); %>                            
                            </div>                        
                        <%
                        ...
                        %>
                            <div class="alert alert-success content2" role="alert">
                                ...
                                <%out.println("<strong>¡Bien hecho!</strong> El Usuario ha sido actualizado con éxito."); %>  
                            </div>                
                        <%
