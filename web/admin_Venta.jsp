                ...
                <tbody>
                    ...
                    %>
                        <div class="alert alert-success content2" role="alert">
                            ...
                            <%out.println("¡Bien hecho! La Venta ha sido creada con éxito."); %> 
                        </div> 
                    <%
                    ...
                    %>
                        <div class="alert alert-success content2" role="alert">
                            ...
                            <%out.println("¡Bien hecho! La Venta se elimino satisfactoriamente."); %>                            
                        </div>                        
                    <%
                    ...
                    %>
                        <div class="alert alert-success content2" role="alert">
                            ...
                            <%out.println("¡Bien hecho! La Venta ha sido actualizada con éxito."); %>  
                        </div>                
                    <%
                        }
                    %>
