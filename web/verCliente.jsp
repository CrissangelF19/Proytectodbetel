           ...
           <div class="pull-left page_title theme_color">
            ...
            <div class="container clear_both padding_fix">
                ...
                <div class="modal-header">                   
                    ...
                    <h4 class="modal-title page_title theme_color" id="myModalLabel"> <i class="glyphicon glyphicon-eye-open"></i> Detalle de Cliente</h4>
            ...
            <div class="row">
                    ...
                    <div class="modal-body"> 
                        ...
                        <div id="Datos" class="tab-pane fade active in">
                            ...
                            <div class="form-group">                                        
                                ...
                                <div class="col-sm-8">                                                    
                                    <input type="text" class="form-control" id="Nombres" name="nombres" value="<%= client.getNombreCompleto()%>">                                      
                                </div>    
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="tipodocidentidad" name="tipodocidentidad" value="<%= client.getTipoDocIdentidad()%>">
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="Nurdocumento" name="numerodocumento" value="<%= client.getNroIdentidad()%>">
                                </div>
                            </div>         
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" class="form-control" id="celular" name="celular" value="<%= client.getCelular()%>">                                        
                                </div>
                            </div>
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="date" name="fechaingreso" id="fecha"  class="form-control datepicker"  value="<%= client.getFechaIngreso()%>">
                                </div>
                            </div>                     
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-8">                                            
                                  <input type="text" class="form-control" id="estado" name="estadoc"  value="<%= client.getEstadoc()%>">                                            
                                </div>
                            </div>
                            </fieldset>               
                        </div>
                        ...
                        <div id="Mas" class="tab-pane" >
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputAmount" name="email" value="<%= client.getEmail()%>">
                                </div>
                            </div> 
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <div class="col-sm-8">                                            
                                    ...
                                    <input type="text" class="form-control" id="Telefono" name="telefono" value="<%= client.getTelefono()%>">                                            
                                </div>
                            </div>    
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="genero" name="genero" value="<%= client.getGenero()%>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="exampleInputEmail2" name="barrio" value="<%= client.getBarrio()%>">
                                </div>
                            </div>      
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="exampleInputEmail2" name="ciudad" value="<%= client.getCiudad()%>">
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="Direccion" name="direccion" value="<%= client.getDireccion()%>">
                                </div>
                            </div>
                       </fieldset>
                ...
                <div class="modal-footer">                
                    <a type="button" href="cliente.jsp" class="btn btn-info">Cerrar</a>                    
                </div>                
