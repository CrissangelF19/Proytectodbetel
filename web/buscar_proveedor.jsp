    ...
    <div class="container clear_both padding_fix">
        ...
        <div class="clearfix">
            <div class="btn-group pull-right">
                <button scr="" href="javascript:void(0);" class="btn btn-info" data-toggle="modal" data-target="#nuevoProv" id="nBtn"><i class="fa fa-plus-square"></i> Nuevo</button>
            </div>
        </div>     
        ...
        <table class="display table table-bordered table-striped dataTable" id="dynamic-table" aria-describedby="dynamic-table_info">
            ...
            <tbody>
                ...
                <!--##### Fila inicial ####-->
                <%
                    if(request.getAttribute("listProveedor")!=null){
                        List<Proveedor> listProveedor =  new ArrayList();
                        listProveedor = (List<Proveedor>) request.getAttribute("listProveedor");
                        ...
                        <div class="tab-content">
                            ...
                            <div id="Datos" class="tab-pane">
                                ...
                                <div class="form-group">                                        
                                    ...
                                    <div class="col-sm-8">                                                    
                                        <input type="text" class="form-control" id="Nombres" name="nombres"  maxlength="45">                                      
                                    </div>    
                                </div>
