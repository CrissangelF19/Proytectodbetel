...
<body class="fixed_header left_nav_fixed atm-spmenu-push dark_theme blue_thm" style="background-color: #f1f1f1">    
    ...
    <div class="container clear_both padding_fix">         
        ...
        <div class="col-md-12">
            ...
            <!--###### Inicio de la Tabla Admin Compras ######-->
                ...
                <tbody>
                    ...
                    %>
                        <div class="alert alert-success content2" role="alert">
                            ...
                            <%out.println("¡Bien hecho! La Compra ha sido creada con éxito."); %> 
                        </div> 
                    <%
                    ...
                    %>
                        <div class="alert alert-success content2" role="alert">
                            ...
                            <%out.println("¡Bien hecho! La Compra se elimino satisfactoriamente."); %>                            
                        </div>                        
                    <%
                    ...
                    %>
                        <div class="alert alert-success content2" role="alert">
                            ...
                            <%out.println("¡Bien hecho! La Compra ha sido actualizada con éxito."); %>  
                        </div>                
                    <%
                        }
                    %>
