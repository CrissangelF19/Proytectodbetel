                ...
                <tbody>
                    ...
                    %>
                        <div class="alert alert-success content2" role="alert">
                            ...
                            <%out.println("¡Bien hecho! El Rol ha sido creado con éxito."); %> 
                        </div> 
                    <%
                    ...
                    %>
                        <div class="alert alert-success content2" role="alert">
                            ...
                            <%out.println("¡Bien hecho! El Rol se elimino satisfactoriamente."); %>                            
                        </div>                        
                    <%
                    ...
                    %>
                        <div class="alert alert-success content2" role="alert">
                            ...
                            <%out.println("¡Bien hecho! El Rol ha sido actualizado con éxito."); %>  
                        </div>                
                    <%
                ...
                <form  action="RolSvl" method="post" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nombreRol" name="nombre" value="" required autofocus maxlength="20">
                            </div>
                        </div>
